	...
	return (
		<footer className="flex flex-col justify-center items-start max-w-2xl mx-auto w-full mb-8">
			...
			<div className="w-full max-w-2xl grid grid-cols-1 gap-4 pb-16 sm:grid-cols-3">
				...
				<div className="flex flex-col space-y-4">
					<ExternalLink href="https://twitter.com/petchkubbb">Twitter</ExternalLink>
					<ExternalLink href="https://github.com/petchkubb">GitHub</ExternalLink>
					<ExternalLink href="https://www.linkedin.com/in/kittichan-ruadrewworakit-b634411b3/">
						Linkedin
					</ExternalLink>
				</div>
				<div className="flex flex-col space-y-4">
					<Link href="/blogs" className="text-gray-500 hover:text-gray-600 transition">
						Blogs
					</Link>
