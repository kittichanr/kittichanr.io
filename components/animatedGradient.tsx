...
const AnimatedGradient = () => {
	return (
		<div className="flex h-40 w-full flex-row items-center justify-center rounded-md bg-gradient-to-r from-gray-100 to-gray-300 dark:from-slate-800 dark:to-slate-900">
