...
export const about = () => {
	return (
		<>
			{"👋, I'm Petch. Software Engineer Experience at"} <b>LMWN</b>{' '}
			{"I'm work in restaurant solution team contribute on wongnai merchant app (WMA)"}
		</>
	)
}
export const bio = () => {
	return (
		<>
			...
			{'I like to learn about a new thing in javascript especially React framework.\n'}
